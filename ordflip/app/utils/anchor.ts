...
import { Ordflip, IDL } from "../idl/ordflip"
...
export const program = new Program<Ordflip>(IDL, programId, {
...
export type PlayerData = IdlAccounts<Ordflip>["playerData"]
export type GameData = IdlAccounts<Ordflip>["gameData"]
